                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if (empty($board)): ?>
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No board members added yet.</td>
                                        </tr>
                                    <?php else: ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if (empty($management)): ?>
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No management members added yet.</td>
                                        </tr>
                                    <?php else: ?>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php if (empty($partners)): ?>
                                        <tr>
                                            <td colspan="6" class="text-center text-muted">No partners added yet.</td>
                                        </tr>
                                    <?php else: ?>
